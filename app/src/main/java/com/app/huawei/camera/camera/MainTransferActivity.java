...
public class MainTransferActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createSpinner() {
        if (this.isEngLanguage()) {
            this.spSourceAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, MainTransferActivity.spSourceList_en);
            this.spDestAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, MainTransferActivity.spDestList_en);
        } else {
            this.spSourceAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, MainTransferActivity.spSourceList);
            this.spDestAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, MainTransferActivity.spDestList);
        }
        ...
        this.spSourceType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                MainTransferActivity.this.srcLanguage = MainTransferActivity.SOURCE_LANGUAGE_CODE[position];
                SmartLog.i(MainTransferActivity.TAG, "srcLanguage: " + MainTransferActivity.this.srcLanguage);
            }
        ...
        this.spDestType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                MainTransferActivity.this.dstLanguage = MainTransferActivity.DEST_LANGUAGE_CODE[position];
                SmartLog.i(MainTransferActivity.TAG, "dstLanguage: " + MainTransferActivity.this.dstLanguage);
            }
    ...
    public boolean isEngLanguage() {
        ...
        if (locale != null) {
            ...
            return strLan != null && MainTransferActivity.EN.equals(strLan);
        }
        return false;
    }
    ...
    private void updateDestLanguage(String code) {
        if (code.equalsIgnoreCase(MainTransferActivity.SOURCE_LANGUAGE_CODE[0]) || code.equalsIgnoreCase(MainTransferActivity.spSourceList.get(0))) {
            this.dstLanguage = MainTransferActivity.DEST_LANGUAGE_CODE[0];
            return;
        }
    ...
    private String getLanguageName(String code) {
        int index = 0;
        for (int i = 0; i < MainTransferActivity.SOURCE_LANGUAGE_CODE.length; i++) {
            if (code.equalsIgnoreCase(MainTransferActivity.SOURCE_LANGUAGE_CODE[i])) {
                index = i;
                break;
            }
        }
